...
import { useConsultarMunicipioQuery } from '@/infrastructure/queries/municipality.queries'
...
//     tiposDeclaración. React Query dedupea: si el modal ya los pidió, salen
//     de cache sin tráfico extra.
//
...
export function useDataOrchestrator(municipalityId: string): DataOrchestratorResult {
  ...
  }, [municipioQ.data, periodosQ.data, tiposDeclaracionQ.data, tiposDocumentoQ.data, municipalityId])
